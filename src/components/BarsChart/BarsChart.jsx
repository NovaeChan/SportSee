...
/**
 * @function formatDataBarsChart
 * @description formats data into an array
 * @param { Object } data 
 * @returns { Array }
 */
 ...
 * @description Component to customise the chart's tooltip
 * @param { Boolean } active - true if bars hovered over
 * @param { Object } payload - the data of overflown bars
 * @returns { HTMLElement }
 */
